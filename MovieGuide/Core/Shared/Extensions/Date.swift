...
public extension Date {
    ...
    ///
    ///     let date = Date() // "Oct 3, 2020, 10:57:11"
    ///     let yesterday = date.yesterday // "Oct 2, 2020, 10:57:11"
    ///
    var yesterday: Date {
    ...
    ///
    ///     let date = Date() // "Oct 3, 2020, 10:57:11"
    ///     let tomorrow = date.tomorrow // "Oct 4, 2020, 10:57:11"
    ///
    var tomorrow: Date {
        return addingTimeInterval(86400.0)
    }
...
public extension Date {
    ...
    /// - Returns: date string.
    func string(withFormat format: String = "dd/MM/yyyy HH:mm",locale:Locale? = Locale(identifier: "en_US")) -> String {
        let dateFormatter = DateFormatter()
...
public extension Date {
    ...
    init?(UTCString: String) {
        ...
        dateFormatter.locale = Locale(identifier: "en_US_POSIX")
        dateFormatter.timeZone = TimeZone.current
        dateFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ss" // 2020-01-17T08:13:18
